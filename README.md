...
1. To manage your new portfolio website you need to add superuser.
   ...
   Create superuser:
    ...
    ```
2. Go to [http://0.0.0.0:8000/admin](http://0.0.0.0:8000/admin) ([http://localhost:8000/admin](http://localhost:8000/admin) for Windows) and manage your jobs and blog posts.
